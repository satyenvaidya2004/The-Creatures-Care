<?php
    ...
    $sql = "SELECT * FROM `rescue` WHERE `name` LIKE '%$search%' OR `contact_no` LIKE '$search' OR `animal` LIKE '%$search%' OR `current_situation` LIKE '%$search%' OR `exact_location` LIKE '%$search%' OR `status` LIKE '%$search%' ORDER BY `r_id` DESC"; 
