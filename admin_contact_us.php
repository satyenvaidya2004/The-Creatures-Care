...
<head>
    ...
    <title>Contact Us Manage - Admin | The Creature's Care</title>
    <!-- Bootstrap link -->
...
<body>
    ...
    <h1 style="text-align:center;">Contact Us Manage</h1><br>
    ...
    $(document).ready(function() {
        ...
        function loadTable() {
            $.ajax({
                url: "bak_show_contact_usdata.php",
                type: "POST",
        ...
        $("#search").on("keyup", function() {
            ...
            $.ajax({
                url: "bak_search_contact_usdata.php",
                type: "POST",
                data: {
                    search: search_term
                },
