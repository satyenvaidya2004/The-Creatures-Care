<?php
    ...
    $sql = "SELECT * FROM `registration` WHERE `username` LIKE '%$search%' OR `email` LIKE '%$search%' OR `contact_no` = '$search' OR `gender` LIKE '%$search%' OR `city` LIKE '%$search%' OR `access` LIKE '%$search%'"; 
